    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="../../assets/assets/img/90x90.jpg"> <span
                        class="navbar-brand-name">Nhóm 2</span></a>
            </div>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    <li class="menu single-menu active">
                        <router-link to="/trang-chu">
                            <a href="/trang-chu" data-toggle="collapse" aria-expanded="true"
                                class="dropdown-toggle autodroprown">
                                <div class="">
                                    <span class="me-1"><i class="fa-solid fa-house fa-lg"
                    ...
                    <li class="menu single-menu active">
                        <router-link to="/viec-lam">
                            <a href="/viec-lam" data-toggle="collapse" aria-expanded="true"
                                class="dropdown-toggle autodroprown">
                                <div class="">
                                    <span class="me-1"><i class="fa-solid fa-building fa-lg"
                                            style="color: #000000;"></i></span>
                                    <span>Việc Làm</span>
                                </div>
                            </a>
                    ...
                    <li class="menu single-menu active">
                        <router-link to="/mau-cv">
                            <a href="/mau-cv" data-toggle="collapse" aria-expanded="true"
                                class="dropdown-toggle autodroprown">
                                <div class="">
                                    <span class="me-1"><i class="fa-solid fa-list fa-lg"
                                            style="color: #000000;"></i></span>
                                    <span>Mẫu CV</span>
                                </div>
                            </a>
